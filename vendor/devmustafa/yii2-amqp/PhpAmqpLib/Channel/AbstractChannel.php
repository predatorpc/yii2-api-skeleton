...
namespace devmustafa\amqp\PhpAmqpLib\Channel;

use devmustafa\amqp\PhpAmqpLib\Connection\AbstractConnection;
...
use devmustafa\amqp\PhpAmqpLib\Helper\MiscHelper;
use devmustafa\amqp\PhpAmqpLib\Wire\AMQPReader;
use devmustafa\amqp\PhpAmqpLib\Message\AMQPMessage;

use devmustafa\amqp\PhpAmqpLib\Helper\Protocol\Protocol080;
use devmustafa\amqp\PhpAmqpLib\Helper\Protocol\Protocol091;
use devmustafa\amqp\PhpAmqpLib\Helper\Protocol\Wait080;
use devmustafa\amqp\PhpAmqpLib\Helper\Protocol\Wait091;
use devmustafa\amqp\PhpAmqpLib\Helper\Protocol\MethodMap080;
use devmustafa\amqp\PhpAmqpLib\Helper\Protocol\MethodMap091;
...
class AbstractChannel
{
    ...
    public function __construct(AbstractConnection $connection, $channel_id)
    {
        ...
        switch ($this->protocolVersion) {
            case '0.9.1':
                self::$PROTOCOL_CONSTANTS_CLASS = 'devmustafa\amqp\PhpAmqpLib\Wire\Constants091';
